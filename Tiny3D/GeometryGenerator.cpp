...
void GeometryGenerator::CreateBox(float width, float height, float depth, MeshData &mesh)
{
	...
	mesh.vertices[0].color = ZCFLOAT3(1.f, 0.f, 0.f);
	...
	mesh.vertices[1].color = ZCFLOAT3(0.f, 0.f, 0.f);
	...
	mesh.vertices[2].color = ZCFLOAT3(1.f, 0.f, 0.f);
	...
	mesh.vertices[3].color = ZCFLOAT3(0.f, 1.f, 0.f);
	...
	mesh.vertices[4].color = ZCFLOAT3(0.f, 0.f, 1.f);
	...
	mesh.vertices[5].color = ZCFLOAT3(1.f, 1.f, 0.f);
	...
	mesh.vertices[6].color = ZCFLOAT3(0.f, 0.f, 0.f);
	...
	mesh.vertices[7].color = ZCFLOAT3(1.f, 1.f, 1.f);
	...
	mesh.vertices[8].color = ZCFLOAT3(1.f, 0.f, 1.f);
	...
	mesh.vertices[9].color = ZCFLOAT3(0.f, 1.f, 1.f);
	...
	mesh.vertices[10].color = ZCFLOAT3(1.f, 1.f, 0.f);
	...
	mesh.vertices[11].color = ZCFLOAT3(0.f, 0.f, 1.f);
	...
	mesh.vertices[12].color = ZCFLOAT3(0.f, 1.f, 0.f);
	...
	mesh.vertices[13].color = ZCFLOAT3(1.f, 0.f, 0.f);
	...
	mesh.vertices[14].color = ZCFLOAT3(0.f, 1.f, 1.f);
	...
	mesh.vertices[15].color = ZCFLOAT3(1.f, 0.f, 1.f);
	...
	mesh.vertices[16].color = ZCFLOAT3(0.f, 0.f, 0.f);
	...
	mesh.vertices[17].color = ZCFLOAT3(1.f, 1.f, 0.f);
	...
	mesh.vertices[18].color = ZCFLOAT3(0.f, 1.f, 1.f);
	...
	mesh.vertices[19].color = ZCFLOAT3(1.f, 0.f, 0.f);
	...
	mesh.vertices[20].color = ZCFLOAT3(0.f, 0.f, 1.f);
	...
	mesh.vertices[21].color = ZCFLOAT3(1.f, 1.f, 1.f);
	...
	mesh.vertices[22].color = ZCFLOAT3(0.f, 1.f, 0.f);
	...
	mesh.vertices[23].color = ZCFLOAT3(1.f, 0.f, 1.f);
